...
public class ContractSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3112585267187484565L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ContractSchema\",\"namespace\":\"ch.scigility.kafka.canonical\",\"fields\":[{\"name\":\"INCO_ID\",\"type\":\"long\"},{\"name\":\"INCO_TYPE\",\"type\":\"long\"},{\"name\":\"INCO_ANNUAL_PREMIUM\",\"type\":\"long\"},{\"name\":\"INCO_START_DATE\",\"type\":\"long\"},{\"name\":\"INCO_END_DATE\",\"type\":\"long\"},{\"name\":\"INCO_INPA_CUST_ID\",\"type\":\"long\"},{\"name\":\"INCO_INAG_ID\",\"type\":\"long\"},{\"name\":\"INCO_RENTABILITY\",\"type\":\"long\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<ContractSchema> ENCODER =
      new BinaryMessageEncoder<ContractSchema>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<ContractSchema> DECODER =
      new BinaryMessageDecoder<ContractSchema>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<ContractSchema> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<ContractSchema> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<ContractSchema>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this ContractSchema to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a ContractSchema from a ByteBuffer. */
  public static ContractSchema fromByteBuffer(
   ...
   */
  public ContractSchema(java.lang.Long INCO_ID, java.lang.Long INCO_TYPE, java.lang.Long INCO_ANNUAL_PREMIUM, java.lang.Long INCO_START_DATE, java.lang.Long INCO_END_DATE, java.lang.Long INCO_INPA_CUST_ID, java.lang.Long INCO_INAG_ID, java.lang.Long INCO_RENTABILITY) {
  ...
  /**
   * Creates a new ContractSchema RecordBuilder.
   * @return A new ContractSchema RecordBuilder
   */
  public static ch.scigility.kafka.canonical.ContractSchema.Builder newBuilder() {
    return new ch.scigility.kafka.canonical.ContractSchema.Builder();
  }

  /**
   * Creates a new ContractSchema RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ContractSchema RecordBuilder
   */
  public static ch.scigility.kafka.canonical.ContractSchema.Builder newBuilder(ch.scigility.kafka.canonical.ContractSchema.Builder other) {
    return new ch.scigility.kafka.canonical.ContractSchema.Builder(other);
  }

  /**
   * Creates a new ContractSchema RecordBuilder by copying an existing ContractSchema instance.
   * @param other The existing instance to copy.
   * @return A new ContractSchema RecordBuilder
   */
  public static ch.scigility.kafka.canonical.ContractSchema.Builder newBuilder(ch.scigility.kafka.canonical.ContractSchema other) {
    return new ch.scigility.kafka.canonical.ContractSchema.Builder(other);
  }

  /**
   * RecordBuilder for ContractSchema instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ContractSchema>
    implements org.apache.avro.data.RecordBuilder<ContractSchema> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ch.scigility.kafka.canonical.ContractSchema.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ContractSchema instance
     * @param other The existing instance to copy.
     */
    private Builder(ch.scigility.kafka.canonical.ContractSchema other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.INCO_ID)) {
        this.INCO_ID = data().deepCopy(fields()[0].schema(), other.INCO_ID);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder setINCOID(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder clearINCOID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder setINCOTYPE(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder clearINCOTYPE() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder setINCOANNUALPREMIUM(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder clearINCOANNUALPREMIUM() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder setINCOSTARTDATE(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder clearINCOSTARTDATE() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder setINCOENDDATE(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder clearINCOENDDATE() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder setINCOINPACUSTID(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder clearINCOINPACUSTID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder setINCOINAGID(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder clearINCOINAGID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder setINCORENTABILITY(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.ContractSchema.Builder clearINCORENTABILITY() {
    ...
    public ContractSchema build() {
      try {
        ContractSchema record = new ContractSchema();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<ContractSchema>
    WRITER$ = (org.apache.avro.io.DatumWriter<ContractSchema>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<ContractSchema>
    READER$ = (org.apache.avro.io.DatumReader<ContractSchema>)MODEL$.createDatumReader(SCHEMA$);
