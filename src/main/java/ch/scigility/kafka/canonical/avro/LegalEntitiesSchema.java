...
public class LegalEntitiesSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3780399734644562022L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LegalEntitiesSchema\",\"namespace\":\"ch.scigility.kafka.canonical.avro\",\"fields\":[{\"name\":\"INCO_ID\",\"type\":\"long\"},{\"name\":\"INCO_TYPE\",\"type\":\"long\"},{\"name\":\"INCO_ANNUAL_PREMIUM\",\"type\":\"long\"},{\"name\":\"INCO_START_DATE\",\"type\":\"long\"},{\"name\":\"INCO_END_DATE\",\"type\":\"long\"},{\"name\":\"INCO_INPA_CUST_ID\",\"type\":\"long\"},{\"name\":\"INCO_INAG_ID\",\"type\":\"long\"},{\"name\":\"INCO_RENTABILITY\",\"type\":\"long\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<LegalEntitiesSchema> ENCODER =
      new BinaryMessageEncoder<LegalEntitiesSchema>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<LegalEntitiesSchema> DECODER =
      new BinaryMessageDecoder<LegalEntitiesSchema>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<LegalEntitiesSchema> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<LegalEntitiesSchema> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<LegalEntitiesSchema>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this LegalEntitiesSchema to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a LegalEntitiesSchema from a ByteBuffer. */
  public static LegalEntitiesSchema fromByteBuffer(
   ...
   */
  public LegalEntitiesSchema(java.lang.Long INCO_ID, java.lang.Long INCO_TYPE, java.lang.Long INCO_ANNUAL_PREMIUM, java.lang.Long INCO_START_DATE, java.lang.Long INCO_END_DATE, java.lang.Long INCO_INPA_CUST_ID, java.lang.Long INCO_INAG_ID, java.lang.Long INCO_RENTABILITY) {
  ...
  /**
   * Creates a new LegalEntitiesSchema RecordBuilder.
   * @return A new LegalEntitiesSchema RecordBuilder
   */
  public static ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder newBuilder() {
    return new ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder();
  }

  /**
   * Creates a new LegalEntitiesSchema RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new LegalEntitiesSchema RecordBuilder
   */
  public static ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder newBuilder(ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder other) {
    return new ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder(other);
  }

  /**
   * Creates a new LegalEntitiesSchema RecordBuilder by copying an existing LegalEntitiesSchema instance.
   * @param other The existing instance to copy.
   * @return A new LegalEntitiesSchema RecordBuilder
   */
  public static ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder newBuilder(ch.scigility.kafka.canonical.avro.LegalEntitiesSchema other) {
    return new ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder(other);
  }

  /**
   * RecordBuilder for LegalEntitiesSchema instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LegalEntitiesSchema>
    implements org.apache.avro.data.RecordBuilder<LegalEntitiesSchema> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing LegalEntitiesSchema instance
     * @param other The existing instance to copy.
     */
    private Builder(ch.scigility.kafka.canonical.avro.LegalEntitiesSchema other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.INCO_ID)) {
        this.INCO_ID = data().deepCopy(fields()[0].schema(), other.INCO_ID);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder setINCOID(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder clearINCOID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder setINCOTYPE(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder clearINCOTYPE() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder setINCOANNUALPREMIUM(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder clearINCOANNUALPREMIUM() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder setINCOSTARTDATE(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder clearINCOSTARTDATE() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder setINCOENDDATE(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder clearINCOENDDATE() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder setINCOINPACUSTID(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder clearINCOINPACUSTID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder setINCOINAGID(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder clearINCOINAGID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder setINCORENTABILITY(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.LegalEntitiesSchema.Builder clearINCORENTABILITY() {
    ...
    public LegalEntitiesSchema build() {
      try {
        LegalEntitiesSchema record = new LegalEntitiesSchema();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<LegalEntitiesSchema>
    WRITER$ = (org.apache.avro.io.DatumWriter<LegalEntitiesSchema>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<LegalEntitiesSchema>
    READER$ = (org.apache.avro.io.DatumReader<LegalEntitiesSchema>)MODEL$.createDatumReader(SCHEMA$);
