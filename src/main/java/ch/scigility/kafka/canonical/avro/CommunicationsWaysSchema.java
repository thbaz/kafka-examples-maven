...
public class CommunicationsWaysSchema extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1839912093491184327L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CommunicationsWaysSchema\",\"namespace\":\"ch.scigility.kafka.canonical.avro\",\"fields\":[{\"name\":\"INCO_ID\",\"type\":\"long\"},{\"name\":\"INCO_TYPE\",\"type\":\"long\"},{\"name\":\"INCO_ANNUAL_PREMIUM\",\"type\":\"long\"},{\"name\":\"INCO_START_DATE\",\"type\":\"long\"},{\"name\":\"INCO_END_DATE\",\"type\":\"long\"},{\"name\":\"INCO_INPA_CUST_ID\",\"type\":\"long\"},{\"name\":\"INCO_INAG_ID\",\"type\":\"long\"},{\"name\":\"INCO_RENTABILITY\",\"type\":\"long\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<CommunicationsWaysSchema> ENCODER =
      new BinaryMessageEncoder<CommunicationsWaysSchema>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<CommunicationsWaysSchema> DECODER =
      new BinaryMessageDecoder<CommunicationsWaysSchema>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageDecoder instance used by this class.
   */
  public static BinaryMessageDecoder<CommunicationsWaysSchema> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<CommunicationsWaysSchema> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<CommunicationsWaysSchema>(MODEL$, SCHEMA$, resolver);
  }

  /** Serializes this CommunicationsWaysSchema to a ByteBuffer. */
  public java.nio.ByteBuffer toByteBuffer() throws java.io.IOException {
    return ENCODER.encode(this);
  }

  /** Deserializes a CommunicationsWaysSchema from a ByteBuffer. */
  public static CommunicationsWaysSchema fromByteBuffer(
   ...
   */
  public CommunicationsWaysSchema() {}
   ...
   */
  public CommunicationsWaysSchema(java.lang.Long INCO_ID, java.lang.Long INCO_TYPE, java.lang.Long INCO_ANNUAL_PREMIUM, java.lang.Long INCO_START_DATE, java.lang.Long INCO_END_DATE, java.lang.Long INCO_INPA_CUST_ID, java.lang.Long INCO_INAG_ID, java.lang.Long INCO_RENTABILITY) {
  ...
  /**
   * Creates a new CommunicationsWaysSchema RecordBuilder.
   * @return A new CommunicationsWaysSchema RecordBuilder
   */
  public static ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder newBuilder() {
    return new ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder();
  }

  /**
   * Creates a new CommunicationsWaysSchema RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new CommunicationsWaysSchema RecordBuilder
   */
  public static ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder newBuilder(ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder other) {
    return new ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder(other);
  }

  /**
   * Creates a new CommunicationsWaysSchema RecordBuilder by copying an existing CommunicationsWaysSchema instance.
   * @param other The existing instance to copy.
   * @return A new CommunicationsWaysSchema RecordBuilder
   */
  public static ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder newBuilder(ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema other) {
    return new ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder(other);
  }

  /**
   * RecordBuilder for CommunicationsWaysSchema instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CommunicationsWaysSchema>
    implements org.apache.avro.data.RecordBuilder<CommunicationsWaysSchema> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing CommunicationsWaysSchema instance
     * @param other The existing instance to copy.
     */
    private Builder(ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.INCO_ID)) {
        this.INCO_ID = data().deepCopy(fields()[0].schema(), other.INCO_ID);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder setINCOID(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder clearINCOID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder setINCOTYPE(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder clearINCOTYPE() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder setINCOANNUALPREMIUM(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder clearINCOANNUALPREMIUM() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder setINCOSTARTDATE(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder clearINCOSTARTDATE() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder setINCOENDDATE(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder clearINCOENDDATE() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder setINCOINPACUSTID(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder clearINCOINPACUSTID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder setINCOINAGID(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder clearINCOINAGID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder setINCORENTABILITY(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ch.scigility.kafka.canonical.avro.CommunicationsWaysSchema.Builder clearINCORENTABILITY() {
    ...
    public CommunicationsWaysSchema build() {
      try {
        CommunicationsWaysSchema record = new CommunicationsWaysSchema();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<CommunicationsWaysSchema>
    WRITER$ = (org.apache.avro.io.DatumWriter<CommunicationsWaysSchema>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<CommunicationsWaysSchema>
    READER$ = (org.apache.avro.io.DatumReader<CommunicationsWaysSchema>)MODEL$.createDatumReader(SCHEMA$);
